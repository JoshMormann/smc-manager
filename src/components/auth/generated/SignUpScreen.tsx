            ...
            <CardContent className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      aria-invalid={!!confirmPasswordError && touched.confirmPassword}
                    />
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <Button
                ...
                <div className="space-y-2">
                  <div className="flex items-start space-x-3">
                    <Checkbox
                      ...
                      disabled={isAnyLoading}
                      className={cn('mt-0.5', termsError && touched.terms && 'border-destructive')}
                      aria-describedby={termsError ? 'terms-error' : undefined}
                      aria-invalid={!!termsError && touched.terms}
                    />
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <Button
                  type="button"
                  variant="outline"
                  onClick={() => handleSsoSignUp('discord')}
                  disabled={isAnyLoading}
