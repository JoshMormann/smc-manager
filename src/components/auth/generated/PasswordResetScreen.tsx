          ...
          <Card className="shadow-xl border-border/50 bg-card/95 backdrop-blur supports-[backdrop-filter]:bg-card/80">
            <CardHeader className="space-y-4 pb-6">
              ...
              <p className="text-center text-sm text-muted-foreground">
                {emailSent ? "We've sent a password reset link to your email address" : "Enter your email address and we'll send you a link to reset your password"}
              </p>
            </CardHeader>
            ...
            <CardContent className="space-y-6">
              ...
              <AnimatePresence>
                ...
                duration: 0.3
                    ...
                    <div className="space-y-2">
                      <h3 className="text-lg font-semibold text-foreground">Email sent successfully</h3>
                ...
                duration: 0.2
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        ...
                        <Input id="reset-email" type="email" placeholder="Enter your email" value={email} onChange={e => setEmail(e.target.value)} onBlur={() => setTouched({
                      ...touched,
                      email: true
              ...
              <AnimatePresence>
                ...
                delay: 0.3
                  ...
                  setEmailError("");
                }} className="text-sm text-primary hover:text-primary/80 p-0 h-auto" disabled={isAnyLoading}>
